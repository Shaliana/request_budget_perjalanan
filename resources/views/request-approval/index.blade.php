...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Approval Request Dana Perjalanan</div>
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs" id="tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="tab-approve" data-toggle="pill" href="#approve" role="tab"
                                aria-controls="approve" aria-selected="false">Disetujui</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="tab-reject" data-toggle="pill" href="#reject" role="tab"
                    ...
                    <div class="tab-content" id="custom-content-below-tabContent">
                        ...
                        <div class="tab-pane fade" id="reject" role="tabpanel" aria-labelledby="tab-reject">
                            <br>
                            <table id="tbl_reject" class="table table-striped table-bordered" width="100%">
                                <thead>
                                    <tr>
                                    <th width="15%">User</th>
                                    <th width="15%">Item Request</th>
...
<script>
        ...
        function showTable(activeTab) {
            var url = "{{ route('requests_approval.json', 'DATA_ID') }}";
                ...
                columns: [
                    ...
                    },
                    {
                        data: 'id', render: function (data, type, full, meta) {
                            ...
                            action += `<div class="col-md-auto"><a href="{{ route('requests_approval.show', 'DATA_ID') }}" class="btn btn-sm btn-info">Show</a></div>`;
                            if (activeTab == "new") {
                                action += `<div class="col-md-auto"><a href="{{ route('requests_approval.review', 'DATA_ID') }}" class="btn btn-sm btn-warning">Review</a></div>`;
                            }
                            action += '</div>';
