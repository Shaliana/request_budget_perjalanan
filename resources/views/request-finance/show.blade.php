        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <hr>
                    <div class="row mb-3">
                        <label for="nominal" class="col-md-4 col-form-label text-md-end">Bukti Transfer</label>

                        <div class="col-md-6">
                            <img class="img-fluid" src="{{ asset('storage/'.$requests->finance->bukti_transfer) }}" alt="">
                        </div>
                    </div>

                    <div class="row mb-3">
                        <label for="information" class="col-md-4 col-form-label text-md-end">Keterangan Transfer</label>

                        <div class="col-md-6">
                            <textarea name="" id="" class="form-control" readonly>{{ $requests->finance->information }}</textarea>
                        </div>
                    </div>
                    @endif
